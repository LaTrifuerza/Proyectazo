...
void Usuario::mostrar_datos()
{
    string aux_codigo2;
    ifstream lectura2;
    bool encontrar=false;
    lectura2.open("guardia.txt",ios::in);
    if(lectura2.is_open())
    {
        fflush(stdin);
...
void Usuario::eliminar_datos()
{
    ...
    string si("Si");
    bool codigo_q=false;
    dar_baja.open("dar_baja.txt",ios::out);
    lectura.open("guarida.txt",ios::in);
