...
{
    do{
    cout<<"Con que emociones necesitas ayuda? \n";
    cout<<"1. Alegria \n";
    cout<<"2. Enojo \n";
    cout<<"3. Miedo \n";
    cout<<"4. Tristeza \n";
...
void Psicologia::Miedo()
{
    ...
    cout<<"4. Cambia tu vision, es decir que veas a los miedos como futuras enseniansas, que te desafian a ir mas alla de ti mismo \n";
    Volver_emociones();
}
